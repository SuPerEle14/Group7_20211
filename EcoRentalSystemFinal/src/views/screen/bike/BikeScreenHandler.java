...
public class BikeScreenHandler extends BaseScreenHandler {
    ...
    private void setBikeInfo() {
        ...
        rentFeebk.setText(Integer.toString(bike.getRentFees()) + "VND / min.");
        rentFeebk.setEditable(false);
        ...
        btnRentBike.setOnMouseClicked(e -> {
            try{
                ...
                if(Configs.card!=null) {
                    ...
                    PopupScreen.error("Please Sign Up to Rent Bike!");
                }
