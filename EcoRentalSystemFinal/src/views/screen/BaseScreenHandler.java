...
import views.infomation.InfoScreenHandler;
...
public class BaseScreenHandler extends FXMLScreenHandler {
	...
	protected InfoScreenHandler viewInfoScreenHandler;
	...
	protected void setMenuImage() {
		...
		File file4 = new File(Configs.IMAGE_PATH + "/" + "infoIcon.png");
	...
	protected void infoShow() throws IOException {
		if (this.viewInfoScreenHandler == null) {
			this.viewInfoScreenHandler = new InfoScreenHandler(this.stage, Configs.INFORMATION_SCREEN_PATH);
		}
		this.viewInfoScreenHandler.show();
	}
